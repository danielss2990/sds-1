...
const BASE_URL = 'http://192.168.1.106:19000';
    ...
    return (
        ...
        <>
            ...
            <View style={styles.container} >
                ...
                <TextInput style={styles.inputText} placeholder="Idade" placeholderTextColor="#9E9E9E" keyboardType="numeric" maxLength={3}/>
                ...
                <View style={styles.platformContainer}>
                    ...
                    onChange={() => handleChangePlatform} activePlatform={platform} />
                </View>
                <RNPickerSelect
